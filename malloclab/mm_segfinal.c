...
//static char *fl_11 = NULL;
//static char *fl_12 = NULL;
//static char *fl_13 = NULL;
...
static char **get_list(size_t size)
{
    ...
    //if(size <= (1 << 14) + 8) return &fl_10;
    //if(size <= (1 << 15) + 8) return &fl_11;
    //if(size <= (1 << 16) + 8) return &fl_12;
    else return &fl_10;
}
...
static void add_node(void *bp)
{
    ...
    /*char **tv;
    printf("add node\n");
    for(tv = &fl_0; *tv != NULL; *tv = NEXT_FREE(*tv))
    {
        printf("before add, fl_0: %p\n", *tv);
    }
    for(tv = &fl_1; *tv != NULL; *tv = NEXT_FREE(*tv))
    {
        printf("before add, f2_0: %p\n", *tv);
    }
    for(tv = &fl_2; *tv != NULL; *tv = NEXT_FREE(*tv))
    {
        printf("before add, fl_0: %p\n", *tv);
    }*/
    size_t size = GET_SIZE(HDRP(bp));
...
/*
    for(tv = &fl_0; *tv != NULL; *tv = NEXT_FREE(*tv))
    {
        printf("after add, fl_0: %p\n", *tv);
    }
    for(tv = &fl_1; *tv != NULL; *tv = NEXT_FREE(*tv))
    {
        printf("after add, f2_0: %p\n", *tv);
    }
    for(tv = &fl_2; *tv != NULL; *tv = NEXT_FREE(*tv))
    {
        printf("after add, fl_0: %p\n", *tv);
...
static void *extend_heap(size_t words)
{
    //if(debudg == 1) printf("extend heap running \n");
    void *bp;
    void *rv;
    size_t size;
...
static char **next_list(char **list)
{
    ...
    //if(list == &fl_10) return &fl_11;
    //if(list == &fl_11) return &fl_12;
    //if(list == &fl_12) return &fl_13;
    else return NULL;
}
/*
